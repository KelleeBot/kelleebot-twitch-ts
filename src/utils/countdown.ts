...
export const countdown = (client: Client, channel: string, seconds: number) => {
...
export const started = (channel: string) => {
    return cdStarted[channel.slice(1)];
};

export const startCountdown = (channel: string) => {
    cdStarted[channel.slice(1)] = true;
};
